#!/bin/bash
# configure the sum.function module

#Getting parameter variables
MODULE_NAME="sum.function"
JAR_VERSION=${1:-1.0.0}
IMAGE_NAME=${2:-osiris-sum-function}
...
VERSIONED_JAR_FILE_NAME=osiris-sum-function-${JAR_VERSION}.jar
UNVERSIONED_JAR_FILE_NAME=osiris-sum-function.jar
...
JAR_FILE=./../../function/sum/${JAR_VERSION}/${VERSIONED_JAR_FILE_NAME}
if [ ! -e ${JAR_FILE} ]
then
